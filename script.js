...
let divAlternandoNomes = document.createElement('p')
...
function handleClick (event) {
    ...
    if(local.textContent === "" && JogadorDaVez === "x"){
        ...
        local.innerText = "✖️"
        divAlternandoNomes.innerText = "VEZ DO JOGADOR: " + input1.value
        ...
        local.innerText = "⭕"
        divAlternandoNomes.innerText = "VEZ DO JOGADOR: " + input2.value
        container.append(divAlternandoNomes)
        JogadorDaVez = "x"
...
function nomeDoVencedor () {
        ...
        if (JogadorDaVez === "o") {
            nomeVencedor.innerText = "O jogador vencedor foi " + input1.value
        } else {
            nomeVencedor.innerText = "O jogador vencedor foi " + input2.value
        }
